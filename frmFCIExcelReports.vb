...
Public Class frmFCIExcelReports
    ...
    Private Sub frmFCIReports_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub populatereportslist()
        ...
        cboReportType.Items.Add("Participants reached by message type")
    ...
    Private Sub ConfigureCrystalReports(ByVal myreporttype As String)
        ...
        Select Case myreporttype
            ...
            Case "participants reached by message type"
                TemplateFileName = "participants_reached_by_message_type"
                StoredProcName = "dbo.rpt_participantbymessagetype"
    ...
    Private Sub cboReportType_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs)
